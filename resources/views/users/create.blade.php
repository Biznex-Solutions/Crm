        ...
        <div class="form-grid">
            ...
            <div class="form-group full-width" id="categoryTargetWrapper" style="{{ old('role', 'employee') === 'admin' ? 'display:none;' : '' }}">
                ...
                <select id="category_target_id" name="category_target_id" class="form-select">
                    ...
                    @foreach($categories as $category)
                        <option value="{{ $category->id }}" {{ old('category_target_id') == $category->id ? 'selected' : '' }}>
            ...
            <div class="form-group full-width">
                ...
                <select id="status" name="status" class="form-select" required>
                    ...
                    <option value="inactive" {{ old('status') == 'inactive' ? 'selected' : '' }}>Inactive (Access blocked until activated)</option>
                </select>
